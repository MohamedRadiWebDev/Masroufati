...
function detectCategoryFuzzy(text: string, categories: Category[], transactionType: 'income' | 'expense'): string | null {
  ...
  const categoryKeywords: Record<string, string[]> = {
    'food': [
      ...
      'ورق عنب', 'كباب حلة', 'رقاق', 'فتة', 'حواوشي', 'فطير', 'عسل اسود', 'طحينة', 'سلطة',
      // International food
      'بيتزا', 'برجر', 'شاورما', 'كباب', 'كفتة', 'باستا', 'مكرونة', 'هوت دوج', 'ساندويتش', 'كنتاكي', 'ماكدونالدز',
      'سوشي', 'صيني', 'هندي', 'تركي', 'لبناني', 'سوري', 'مغربي',
    ...
    'shopping': [
      ...
      'سبينس', 'كازيون', 'راكب', 'فتح الله', 'خير زمان', 'اولاد رجب',
      // Clothing
      ...
      'بوتاجاز', 'فرن', 'مايكرويف', 'خلاط', 'مكنسة كهربائية', 'مكواة'
    ],
    'entertainment': [
      // Cinema and shows
    ...
    'insurance': [
      ...
      'تأمين على الحياة', 'حوادث', 'مسئولية مدنية'
    ]
  };
