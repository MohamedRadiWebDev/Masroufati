...
function detectCategoryFuzzy(text: string, categories: Category[], transactionType: 'income' | 'expense'): string | null {
  ...
  const categoryKeywords: Record<string, string[]> = {
    'food': [
      // Basic food terms
      'أكل', 'طعام', 'غداء', 'فطار', 'فطور', 'عشا', 'عشاء', 'وجبة', 'وجبات',
      // Restaurants and cafes
      'مطعم', 'مطاعم', 'كافيه', 'كافيتيريا', 'فودكورت', 'ديليفري', 'تيك اواي',
      // Beverages
      'شاي', 'قهوة', 'عصير', 'مياه', 'ماء', 'بيبسي', 'كوكاكولا', 'شراب', 'عصائر',
      // Egyptian food
      'فول', 'طعمية', 'كشري', 'ملوخية', 'محشي', 'فراخ', 'لحمة', 'سمك', 'رز', 'أرز',
      // International food
      'بيتزا', 'برجر', 'شاورما', 'كباب', 'كفتة', 'باستا', 'مكرونة',
      // Basics and groceries
      'عيش', 'خبز', 'لبن', 'حليب', 'جبنة', 'جبن', 'زيت', 'سكر', 'شعيرية', 'حاجات اكل',
      // Sweets and snacks
      'حلويات', 'شوكولاتة', 'ايس كريم', 'كيك', 'تورتة', 'بسكويت', 'شيبسي'
    ],
    'transport': [
      // Public transport
      'مواصلات', 'موصلات', 'اتوبيس', 'أتوبيس', 'مترو', 'مايكروباص', 'ميكروباص',
      // Ride services
      'تاكسي', 'اوبر', 'كريم', 'اندرايف', 'سويفل', 'توك توك', 'بجاج',
      // Private transport
      'سيارة', 'عربية', 'موتوسيكل', 'عجلة', 'دراجة',
      // Fuel and maintenance
      'بنزين', 'سولار', 'وقود', 'غاز طبيعي', 'اسطى', 'صيانة', 'غيار', 'زيت موتور',
      // Travel
      'قطار', 'طيارة', 'طيران', 'سفر', 'رحلة', 'تذكرة', 'تذاكر', 'مطار'
    ],
    'bills': [
      // Utilities
      'فواتير', 'فاتورة', 'كهرباء', 'مياه', 'غاز', 'شركة المياه', 'شركة الكهرباء',
      // Telecom
      'تليفون', 'موبايل', 'نت', 'انترنت', 'واي فاي', 'كابل', 'dsl', 'فايبر',
      'فودافون', 'اورانج', 'اتصالات', 'وي', 'تي داتا', 'لينك', 'رصيد', 'شحن'
    ],
    'shopping': [
      // General shopping
      'تسوق', 'تسويق', 'شراء', 'شريت', 'اشتريت', 'حاجات', 'مشتريات',
      // Stores
      'سوبرماركت', 'هايبر', 'مول', 'سنتر', 'محل', 'دكان', 'بقالة', 'جمعية',
      // Clothing
      'ملابس', 'هدوم', 'جزمة', 'حذاء', 'بنطلون', 'قميص', 'تيشيرت', 'فستان', 'جلابية',
      'شنطة', 'حقيبة', 'ساعة', 'اكسسوارات', 'نضارة',
      // Personal care
      'عطر', 'كريم', 'شامبو', 'صابون', 'مكياج', 'مستحضرات تجميل'
    ],
    'entertainment': [
      // Cinema and shows
      'سينما', 'فيلم', 'مسرح', 'كونسرت', 'حفلة', 'مهرجان',
      // Games and activities
      'لعبة', 'العاب', 'بولينج', 'بلايستيشن', 'جيم', 'نادي', 'جيم', 'سبورت',
      // Sports
      'كورة', 'كرة قدم', 'مباراة', 'ملعب', 'نادي رياضي',
      // Fun places
      'ترفيه', 'ملاهي', 'اكوا بارك', 'نادي', 'كافيه', 'قهوة', 'شيشة'
    ],
    'health': [
      // Medical services
      'دكتور', 'طبيب', 'دكتورة', 'كشف', 'عيادة', 'مستشفى', 'مركز طبي',
      // Specialties
      'أسنان', 'عيون', 'جلدية', 'باطنة', 'عظام', 'نساء وتوليد', 'اطفال',
      // Procedures
      'عملية', 'جراحة', 'تحليل', 'تحاليل', 'أشعة', 'موجات صوتية', 'منظار',
      // Pharmacy
      'صيدلية', 'دوا', 'دواء', 'علاج', 'فيتامين', 'مكمل غذائي', 'حقنة'
    ],
    'salary': [
    ...
    'education': [
      'تعليم', 'مدرسة', 'جامعة', 'كورس', 'دورة', 'كتاب', 'كتب', 'قرطاسية',
      'مصاريف دراسية', 'رسوم', 'دروس خصوصية'
    ],
    'home': [
      'بيت', 'شقة', 'منزل', 'ايجار', 'ايجار', 'اثاث', 'موبيليا', 'ديكور',
      'صيانة', 'نظافة', 'عمالة منزلية'
    ],
    'insurance': [
      'تأمين', 'تأمينات', 'بوليصة', 'قسط', 'تكافل'
    ]
  };
