...
const expenseKeywords = [
  ...
  'هدفع', 'هصرف', 'هشتري', 'بشتري', 'بصرف', 'بدفع', 'حصرف', 'حدفع', 'حشتري',
  'مشتري', 'ماشي', 'راح', 'راحت', 'اتصرف', 'اتدفع', 'خلاص', 'دي فلوس', 'فلوس راحت'
];

// Income keywords  
const incomeKeywords = [
  'دخل', 'دخول', 'استلم', 'استلمت', 'وصل', 'وصلت', 'ربح', 'ربحت',
  'اخد', 'اخدت', 'جاني', 'جالي', 'حصلت', 'قبض', 'قبضت', 'هاخد', 'هستلم',
  'هقبض', 'باخد', 'بستلم', 'بقبض', 'حاخد', 'حستلم', 'حقبض', 'واصل', 'واصلة',
  'جه', 'جت', 'اتقبض', 'اتاخد', 'اتاستلم', 'فلوس جاية', 'فلوس داخلة', 'جايني'
];
